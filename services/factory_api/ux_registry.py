...
ROUTE_METADATA_REGISTRY: tuple[RouteMetadata, ...] = (
    ...
    RouteMetadata("ANALYZER_HOME", "/ui/analyzer", "Analyzer", "workspaces", "analytics_center", parent_route_key="CONTROL_CENTER", in_primary_nav=True),
    RouteMetadata("ANALYZER_OVERVIEW", "/ui/analyzer/overview", "Analyzer Overview", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_CHANNELS", "/ui/analyzer/channels", "Analyzer Channels", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_RELEASES", "/ui/analyzer/releases", "Analyzer Releases", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_BATCHES", "/ui/analyzer/batches", "Analyzer Batches", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_PORTFOLIO", "/ui/analyzer/portfolio", "Analyzer Portfolio", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_ANOMALIES", "/ui/analyzer/anomalies", "Analyzer Anomalies", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_RECOMMENDATIONS", "/ui/analyzer/recommendations", "Analyzer Recommendations", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    RouteMetadata("ANALYZER_REPORTS", "/ui/analyzer/reports", "Analyzer Reports", "workspaces", "analytics_center", parent_route_key="ANALYZER_HOME"),
    ...
    RouteMetadata("PROMPT_REGISTRY_LINKED_ACTION_REQUESTS", "/ui/prompt-registry/linked-action-requests", "Prompt Linked Action Requests", "workspaces", "entity_drilldown", parent_route_key="PROMPT_REGISTRY"),
    RouteMetadata("PROMPT_REGISTRY_DISPATCH_ATTEMPTS", "/ui/prompt-registry/linked-action-dispatch-attempts", "Prompt Dispatch Attempts", "workspaces", "entity_drilldown", parent_route_key="PROMPT_REGISTRY"),
