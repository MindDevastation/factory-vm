...
class TestOpsRetentionPoliciesP0S1(unittest.TestCase):
    ...
    def test_retention_windows_and_log_dir_contract(self) -> None:
        env_vars = {
            ...
            "FACTORY_RETENTION_EXPORT_DAYS": "7",
            "FACTORY_RETENTION_TRANSIENT_REPORT_DAYS": "8",
            "FACTORY_RETENTION_TERMINAL_WORKSPACE_HOURS": "72",
            "FACTORY_RETENTION_FAILED_WORKSPACE_DAYS": "7",
            "FACTORY_RETENTION_STALE_SCRATCH_HOURS": "30",
        ...
        self.assertEqual(cfg.windows.export_days, 7)
        self.assertEqual(cfg.windows.transient_report_days, 8)
        self.assertEqual(cfg.windows.terminal_workspace_hours, 72)
        self.assertEqual(cfg.windows.failed_workspace_days, 7)
        self.assertEqual(cfg.windows.stale_scratch_hours, 30)
    ...
    def test_retention_windows_defaults(self) -> None:
        ...
        self.assertEqual(windows.export_days, 7)
        self.assertEqual(windows.transient_report_days, 7)
        self.assertEqual(windows.terminal_workspace_hours, 72)
        self.assertEqual(windows.failed_workspace_days, 7)
        self.assertEqual(windows.stale_scratch_hours, 24)
