...
- New microfeature branches must start from a fresh `origin/main`.
...
- Older PRs already in flight are not rewritten retroactively just because this guide exists.
